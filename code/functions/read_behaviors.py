...
def read_dev_behaviors(path='/home/ming/GraduateProject/Data/MINDlarge_dev/behaviors_1.parquet'):
    return pl.read_parquet(path)
def read_small_train_behaviors(path='/home/ming/GraduateProject/Data/MINDsmall_train/behaviors.parquet'):
    return pl.read_parquet(path)
def read_small_dev_behaviors(path='/home/ming/GraduateProject/Data/MINDsmall_dev/behaviors.parquet'):
    return pl.read_parquet(path)
def  read_behaviors():
